...
nmb = journalistes.count
a = []
while a[4] == nil
    a << journalistes[rand(1..nmb)]
    a = a.uniq
end

#x = 0
#while a[x]
#	client.update("@#{a[x]} Ton dernier article pète des culs par rangée de douze!!! #bonjour_monde")
#	x += 1	
#end
...
client.search('#bonjour_monde').take(5).each do |tweet|
	if tweet.user != 1084779381766176768
